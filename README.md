<div align="center">
  ...
  <a href="mailto:diyajoshi1909@gmail.com"><img src="./assets/link-email.svg" height="38" alt="Email diyajoshi1909@gmail.com" /></a>
</div>

<br />

<p align="center">
  Over the years, I've found myself working across data, embedded systems, applied AI, and product. I enjoy making sense of messy things, whether that means finding a pattern in a spreadsheet, tracing a signal through a system, or taking an unconventional idea far enough to see if it might actually work.
</p>
...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      <sub>PRODUCT</sub>
      <h3>Aegis</h3>
      <p>A campus utility platform for NSUT students that I led product for. Recurring student complaints became four scoped modules in one app: scholarship discovery, lost-and-found matching, proctored skill assessments, and syllabus help. Cut scope hard enough to ship a working MVP in 36 hours.</p>
      <p><kbd>product lead</kbd> <kbd>scoping</kbd> <kbd>TypeScript</kbd> <kbd>face detection</kbd></p>
      <a href="https://github.com/diyajoshii/Aegis-NSUT-Campus-Utility-Platform">source</a>
    </td>
    <td width="50%" valign="top">
      <sub>PRODUCT · ML</sub>
      <h3>Prodessy</h3>
      <p>Built for the IIM Indore Prodyssey case competition, where it reached the national final. A forecasting assistant for product managers who catch slippage too late: a ranked queue of at-risk tasks, predicted completion dates, and SHAP explanations for why each task was flagged.</p>
      <p><kbd>LightGBM</kbd> <kbd>SHAP</kbd> <kbd>NLP</kbd> <kbd>MVP scoping</kbd></p>
      <a href="https://github.com/diyajoshii/Prodessy-IIMIndore">source</a>
    </td>
  </tr>
</table>

<p align="center"><sub>Off GitHub: a non-invasive blood-glucose estimator from PPG signals, R² 0.989, optimised to 1.2 MB for edge deployment.</sub></p>
